...
const wavePattern = [0, 8, 12, 8, 0, -8, -12, -8];
        ...
        >
            ...
            {outcomes.map((outcome, index) => {
                const points = Array.from({length: 24}, (_, pointIndex) => {
                    ...
                    const wave = wavePattern[(pointIndex + index * 2) % wavePattern.length];
            ...
            <text x="402" y="46" fill="#7d8994" fontSize="12">90%</text>
            <text x="402" y="100" fill="#7d8994" fontSize="12">60%</text>
            <text x="402" y="142" fill="#7d8994" fontSize="12">30%</text>
        </svg>
    );
}
